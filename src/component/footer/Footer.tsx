...
const powerBy = ['Misono Mika', 'Shikibe Mayu', 'Shiki Natsume', 'Eris Greyrat', 'Waraku Chise'];
...
const Footer = memo(() => {
  ...
  return (
    <footer className='moe-video-footer-container'>
      ...
      <p className='text-gray-400 text-center text-sm select-none'>© 2024 Moe Video. All Rights Reserved.</p>
    </footer>
  );
});
